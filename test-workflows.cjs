...
assert.equal(matchTopics('退院時サマリを使って病院へ情報提供した')[0].id,'information');
...
console.log('PASS: 19 routes; every rule/case reference; mixed tasks; excluded cases; discharge regression; asset paths.');
